...
for jsonCount in data['date']:
	for optionCount in range(4)
		if type(jsonCount['option'][optionCount]) is not bool:
			if jsonCount['option'][optionCount] == 0:
				jsonCount['option'][optionCount] = False
			elif jsonCount['option'][optionCount] == 1:
				jsonCount['option'][optionCount] = True
